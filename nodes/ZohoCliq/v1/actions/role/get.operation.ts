...
import { ROLE_GET_AGENT_DETAILS_LINK } from '../../helpers/linkConstants';
...
const requiredScope = getRequiredScopeForOperation('role', 'get');

const properties: INodeProperties[] = [
	{
		...roleIdLocator,
		description: 'The unique role ID to retrieve',
	},
	{
		displayName: `Get Role Docs: <a href="https://www.zoho.com/cliq/help/restapi/v2/#get-roles" target="_blank" rel="noopener noreferrer">Open Zoho REST API Reference</a> REQUIRED SCOPES: <code>${requiredScope}</code>`,
		name: 'getRoleDocsNotice',
		type: 'notice',
		default: '',
	},
	{
		displayName: `Zoho Cliq Role/Get Role as AI Tool Setup Guide: <a href="${ROLE_GET_AGENT_DETAILS_LINK}" target="_blank" rel="noopener noreferrer">Open Tool Setup Guide</a>`,
		name: 'getRoleAiToolGuideNotice',
		type: 'notice',
		default: '',
	},
];
...
export async function execute(
	...
	for (let i = 0; i < items.length; i++) {
		...
		try {
			...
			if (
				pushRoleRecoverableError(this, returnData, i, 'get', error, {
